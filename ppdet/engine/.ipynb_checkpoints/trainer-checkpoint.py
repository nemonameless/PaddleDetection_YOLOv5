...
#                 for epoch_id in range(0, epoches):
...
# #                                 epoch_i = epoch_i + 1
# #                             print(epoch_id)
#                             decayed_lr = lr0 * lf(epoch_i)
#                             lr_b_l.append(decayed_lr)
#                             lr_w_and_bn_l.append(decayed_lr)
# #                 print('lr的bound长度') 
# #                 print(len(boundary))
# #                 print('lr的长度')
# #                 print(len(lr_w_and_bn_l))
# #                 print(lr_w_and_bn_l[-1])
