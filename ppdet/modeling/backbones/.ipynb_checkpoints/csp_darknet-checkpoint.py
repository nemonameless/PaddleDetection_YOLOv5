...
class BaseConv(nn.Layer):
    ...
    def __init__(
        ...
        self.bn = nn.BatchNorm2D(out_channels,momentum=0.97, epsilon=1e-3,weight_attr=ParamAttr(regularizer=L2Decay(0.0)),
            bias_attr=ParamAttr(regularizer=L2Decay(0.0))) #, momentum=0.03, epsilon=1e-3)
